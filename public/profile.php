...
/** @var mysqli $conn */
// PROTEKSI HAK AKSES: Jika belum login, tendang ke halaman login
...
// 1. Ambil data profil user yang sedang login saat ini dari tabel pengguna
$q_user = mysqli_query($conn, "SELECT * FROM pengguna WHERE username = '$username_session'");
$user   = mysqli_fetch_assoc($q_user);

// Ambil inisial nama untuk avatar (Contoh: "Febrianus Leona" -> URL API UI-Avatars)
// Menggunakan background ungu khas Windmill (#9333ea) dan teks putih
...
// 2. PROSES BACKEND: KETIKA TOMBOL SAVE DIKLIK
if (isset($_POST['update_profile'])) {
    $id_pengguna   = $user['id_pengguna']; // Mengunci target berdasarkan ID Pengguna asli
    ...
    // Cek apakah username baru kembar dengan milik orang lain di DB
    ...
    // Jika password diisi, enkripsi baru. Jika tidak, update nama & username saja.
    ...
    if (mysqli_query($conn, $query_update)) {
        // 1. Perbarui session username agar login tidak terputus
        $_SESSION['username'] = $username_baru;

        // PERBAIKAN UTAMA: Inject baris ini agar nama lengkap di header langsung ganti seketika!
        ...
        <div class="flex flex-col flex-1 w-full min-w-0">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <!-- Alert Notifikasi Status Perubahan -->
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-12">
                        ...
                        <!-- CARD KIRI: PREVIEW AVATAR INISIAL (REAL-TIME API TANPA SAVE STORAGE) -->
                        ...
                        <!-- CARD KANAN: FORM EDIT PROFIL DATA -->
